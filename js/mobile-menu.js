document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".u-navigation-list");
  const headerRef = document.querySelector(".u-header");
  const navigationRef = document.querySelector(".u-navigation");
